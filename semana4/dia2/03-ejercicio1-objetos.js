let peliculas = [
  ...
  },
  {
    ...
    "overview": "Tras nuestro mundo hay otro: un mundo de monstruos peligrosos y poderosos que gobiernan sus dominios con una ferocidad mortal. Cuando la teniente Artemis (Milla Jovovovich) y sus leales soldados son transportados de nuestro mundo al nuevo mundo, la imperturbable teniente recibe el golpe de su vida. En su desesperada batalla por sobrevivir contra enormes enemigos con poderes increíbles y ataques imparables y repugnantes, Artemis se unirá a un hombre misterioso que ha encontrado la forma de defenderse.",
    "popularity": 2294.441,
  ...
  },
  {
    ...
    "popularity": 3416.813,
    "poster_path": "/yHpNgjEXzZ557YiZ2r3VrKid788.jpg",
  ...
  },
  {
    ...
    "popularity": 1481.451,
    "poster_path": "/x6TTdrTeBVDKVCf9FUERmwNty7W.jpg",
  ...
  },
  {
    ...
    "popularity": 1416.601,
    "poster_path": "/q2KhGQQXdunhiJZuuIxGu27rji.jpg",
    "release_date": "2021-02-11",
    "title": "Punto rojo",
    "video": false,
    "vote_average": 6.5,
  ...
  },
  {
    ...
    "overview": "Akeem se entera de que tiene un hijo perdido hace mucho tiempo en los Estados Unidos y debe regresar a Estados Unidos para conocer al improbable heredero al trono de Zamunda. Una secuela de la comedia de 1988 'Coming to America'.",
    "popularity": 2243.494,
    "poster_path": "/jJFvY25lPaKlapYOeIH6N5aKcbh.jpg",
  ...
  },
  {
    ...
    "popularity": 1121.387,
    "poster_path": "/ycqQvI43tlmBRrf58Yo7D4Membx.jpg",
  ...
  },
  {
    ...
    "overview": "Deke, un ayudante del sheriff del condado de Kern quemado, CA se une a Baxter, un detective experto en LASD, para atrapar a un asesino en serie. El olfato de Deke para las \"pequeñas cosas\" resulta inquietantemente preciso, pero su voluntad de eludir las reglas envuelve a Baxter en un dilema desgarrador. Mientras tanto, Deke debe luchar con un oscuro secreto de su pasado.",
    "popularity": 977.371,
    "poster_path": "/dOb7bALn1uZZ7XYX1NT5Xfe9kbE.jpg",
  ...
  },
  {
    ...
    "popularity": 877.637,
    "poster_path": "/7ZdzQTmdwe6ztwW7m7TEpu3D1sw.jpg",
  ...
  },
  {
    ...
    "popularity": 872.253,
    "poster_path": "/tA3k9LyE2togmIuNnOgw6SmzWus.jpg",
  ...
  },
  {
    ...
    "popularity": 722.412,
    "poster_path": "/gI9oVLHXgPYidW2W4A7p1pYW9QB.jpg",
  ...
  },
  {
    ...
    "popularity": 678.907,
    "poster_path": "/jOMK2YFKtzXGTm0tedsurDj5pFh.jpg",
  ...
  },
  {
    ...
    "popularity": 714.892,
    "poster_path": "/mCYN3bccjOG0w857JTf5UOKsPEH.jpg",
  ...
  },
  {
    ...
    "popularity": 651.402,
    "poster_path": "/A3BP44EvnJIIhyNVwPT0IpvNAoc.jpg",
  ...
  },
  {
    ...
    "popularity": 648.081,
    "poster_path": "/a2fmufY8h0SirNKt37yprZdf7xi.jpg",
...
function conMasGeneros() {
  let cant = 0;
  let listaPeliculas = [];

  for (const pelicula of peliculas) {
    if(pelicula.genre_ids.length >= cant) {
      if(cant !== pelicula.genre_ids.length) {
        listaPeliculas = [];
      }
      cant = pelicula.genre_ids.length;
      listaPeliculas.push(pelicula.original_title);
    }
  }
